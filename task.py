...
def run(argv=None):   
    ...
    (p
     | 'Read from a File' >>  beam.io.ReadFromText('gs://dataflow-pipeline-maven/100 Records.csv', skip_header_lines=1)
     | 'String To BigQuery Row' >> beam.Map(lambda s: data_ingestion.parse_method(s))
     | 'Write to BigQuery' >> beam.io.WriteToBigQuery('dataflow-pipeline-maven:Employee.employee_temp',
                                            schema=SCHEMA,
